...
public class Login extends JFrame {
	...
	public Login() {
		...
		textUserName.setBounds(27, 75, 179, 19);
		panel.add(textUserName);
		textUserName.setColumns(10);
		
		JButton btnLogin = new JButton("Login");
		btnLogin.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnLogin.setBounds(365, 188, 100, 34);
		panel.add(btnLogin);
		
		JButton btnCancel = new JButton("Cancel");
		btnCancel.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnCancel.setBounds(475, 188, 92, 34);
		panel.add(btnCancel);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(27, 136, 179, 19);
		...
		btnCancel.addActionListener(e -> System.exit(0)); //  atunci cand apasam "Cancel" el va iesi din tab login
	}
